...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'MTE1NDUwMTI0MDAwMDAwMDM5MTEyNjc3@MTAxODc2NTEzOTAwMDAwMDAxMDMyMDY2OQ==@MTAxODEyOTI4MDAwMDAwMDQwNDAxMDgz',
  'MTE1NDUwMTI0MDAwMDAwMDM5MTEyNjc3@MTAxODc2NTEzOTAwMDAwMDAxMDMyMDY2OQ==@MTAxODEyOTI4MDAwMDAwMDQwNDAxMDgz'
]
...
function readShareCode() {
  return new Promise(resolve => {
    $.get({url: `http://api.turinglabs.net/api/v1/jd/pet/read/0/`}, (err, resp, data) => {
      try {
        if (err) {
